#!/usr/bin/env python
# =============================================================================
# Margatsni CLI Endpoint
# =============================================================================
#
# CLI enpoint of the Margatsni library.
# Exaclty the same as the Minet library, but using build_parser from Margatsni
#
import csv
import sys
import ctypes
...
from minet.cli.argparse import resolve_arg_dependencies, get_subparser
from minet.cli.exceptions import NotResumableError, InvalidArgumentsError, FatalError

from margatsni.cli.argparse import build_parser
